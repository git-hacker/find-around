...
<div id="main-content" class="content">
    ...
    <div class="page-header page-header1 clearfix">
        ...
        <div class="content-box-content">
            <!--表单 start-->
            <form action="<?php echo U('Kc/addkc');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group" id="">
                    <label for="title" class="col-sm-3 control-label"><em class="prompt-red">*</em>课程名称：</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="title" name="name"  placeholder="课程名称">
                    </div>
                </div>
                <div class="form-group" id="">
                    <label for="ktime" class="col-sm-3 control-label"><em class="prompt-red">*</em>课时：</label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" id="ktime" name="ktime"  placeholder="课时">
                    </div>
                </div>
                <div class="form-group" id="">
                    <script>
