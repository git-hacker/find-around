...
<div id="main-content" class="content">
    ...
    <div class="page-header page-header1 clearfix">
        ...
        <div class="content-box-content">
            <!--表单 start-->
            <form action="<?php echo U('Teac/editteac');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group" id="">
                    <label for="title" class="col-sm-3 control-label"><em class="prompt-red">*</em>姓名：</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name"  placeholder="姓名" value="<?php echo ($res['name']); ?>">
                ...
                <div class="form-group" id="">
                    ...
                    <div class="col-sm-9">
                        <input type="tel" class="form-control" id="tel" name="account"  placeholder="手机号" value="<?php echo ($res['account']); ?>">
                    </div>
                </div>
                <div class="form-group" id="">
                    <label for="title" class="col-sm-3 control-label"><em class="prompt-red">*</em>性别：</label>
                    <div class="col-sm-9">
                        <input type="radio" name="sex" value="1" class="sex" <?php if($res['sex'] == 1): ?>checked<?php endif; ?>>男
                        <input type="radio" name="sex" value="2" class="sex" <?php if($res['sex'] != 1): ?>checked<?php endif; ?>>女
                    </div>
                </div>
                <div class="form-group" id="">
                    <script>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div id="imgPreview1">
                            <?php if(!empty($res['headpic'])): ?><img id='img1' src="Uploads/<?php echo ($res['headpic']); ?>" style='width:100px;height:100px'/><?php endif; ?>
                        </div>
                    </div>
                </div>
