...
<div id="main-content" class="content">
    ...
    <div class="page-header page-header1 clearfix">
        ...
        <div class="content-box-content">
            <!--表单 start-->
            <form action="<?php echo U('Article/addArticle');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content" id="content" style="width:auto;height:300px;visibility:hidden;"><?php echo ($res['content']); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
